...
public class MassageUpdate extends JPanel {
    ...
    public void initData(User user) {
        ...
        Gender.setSelectedIndex(user.getGender()==0?0:1);
    ...
    private void update(User user){
        if(studentUtils.isNotNull(Name)&&studentUtils.isNotNull(AccountNumber)&&studentUtils.isNotNull(StudentNumber)&&studentUtils.isNotNull(Phone)&&studentUtils.isNotNull(Email)) {
