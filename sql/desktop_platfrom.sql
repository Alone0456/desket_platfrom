...
CREATE TABLE `user`  (
  ...
  `passward` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '密码',
  ...
  `post` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '邮箱',
...
CREATE TABLE `user_book_borrow`  (
  ...
  `borrow_user_id` int NOT NULL COMMENT '借阅用户id',
...
CREATE TABLE `user_bug_message`  (
  ...
  `bug_sovle` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '报错解决',
...
CREATE TABLE `user_bug_type`  (
  ...
  `bug_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'bug类型',
  `bug_id` bigint NOT NULL COMMENT '报错id'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `user_file_up`  (
  `up_id` bigint NOT NULL COMMENT '上传id',
  `user_id` int NOT NULL COMMENT '用户id',
...
CREATE TABLE `user_login_log`  (
  `log_id` bigint NOT NULL COMMENT '登录日志id',
  `user_id` int NOT NULL COMMENT '用户id',
